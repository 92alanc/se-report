...
namespace SE_Report.Forms
{
    public partial class Pending : Form
    {
        ...
        private void settings()
        {
            ...
            DataGridViewColumn forecast = Table.Columns[5]; // forecast
            ...
            forecast.Width = 100;
            forecast.HeaderText = "FORECAST";
            forecast.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            forecast.SortMode = DataGridViewColumnSortMode.NotSortable;

            Table.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            Table.RowHeadersWidth = 60;

            Table.Sort(forecast, System.ComponentModel.ListSortDirection.Ascending);
