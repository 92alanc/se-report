...
{
    public partial class EfuseChecklist : Form
    {
        public EfuseChecklist()
        {
            InitializeComponent();
        }


        private void EFUSE_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        */
        private void StartChecklist()
        {
            ...
            string filepath = @"\\lgmcfs-sp\SW\CM\SE\TOOLS\DATABASE\Checklists\Efuse Checklist\";
