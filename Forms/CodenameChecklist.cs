...
{
    public partial class CodenameChecklist : Form
    {
        public CodenameChecklist()
        {
            InitializeComponent();
        }


        private void Codename_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        */
        private void StartChecklist()
        {
            ...
            string filepath = @"\\lgmcfs-sp\SW\CM\SE\TOOLS\DATABASE\Checklists\Codename Checklist\";
